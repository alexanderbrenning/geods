...
## 21. Dezember: Volunteered Geographic Information (VGI)

<img src="figures/vgi.png" width="50%" />

🌍🤝 **<span style="color:blue">Volunteered Geographic Information (VGI)</span>** bezeichnet Geodaten, die <span style="color:blue">freiwillig von Nutzer:innen</span> erzeugt und geteilt werden.
Menschen kartieren ihre Umwelt selbst – mit Smartphone, GPS oder lokalem Wissen.

Das bekannteste Beispiel ist [OpenStreetMap](https://www.openstreetmap.org/):
Tausende Freiwillige erfassen weltweit Straßen, Gebäude, Radwege oder POIs – oft aktueller als offizielle Datensätze 🚲🏘️.

VGI ist eng verwandt mit <span style="color:blue">Crowdsourcing</span>, geht aber konzeptionell weiter:
Nicht Institutionen steuern die Datenerhebung, sondern die Zivilgesellschaft selbst.

👉 Chancen: hohe Aktualität, globale Abdeckung, demokratische Datenerzeugung.

⚠️ Herausforderungen: Datenqualität, räumliche Verzerrungen und soziale Ungleichgewichte.

Kurz gesagt:
**VGI zeigt, dass Geodaten nicht nur gemessen, sondern auch gemeinsam gemacht werden.**
...
Eine **<span style="color:blue">Geodateninfrastruktur (GDI)</span>** ist kein einzelnes System, sondern ein organisiertes Zusammenspiel aus
Geodaten, Metadaten, Standards, Diensten und Institutionen.

**Ihr Ziel:** Geodaten und Webdienste sollen <span style="color:blue">auffindbar, zugänglich, kombinierbar und nutzbar</span> sein, und zwar über Organisationsgrenzen hinweg.

Auf europäischer Ebene wird das durch die **<span style="color:blue">INSPIRE-Richtlinie</span>** geregelt.
Sie verpflichtet Behörden, ihre Geodaten standardisiert bereitzustellen – etwa zu Themen wie Umwelt, Verkehr, Landnutzung oder Verwaltungseinheiten.

Dank GDI und INSPIRE können Daten von Kommunen, Ländern, Bund und EU zusammengeführt werden –
z. B. für Umweltberichte 🌱, Raumplanung 🏗️ oder Krisenmanagement 🚨. Hier ein Beispiel aus dem [Geoportal Thüringen](https://geoportal.thueringen.de/).

👉 Ohne Geodateninfrastrukturen gäbe es zwar viele Karten –
aber **keine funktionierende, verlässliche Geodatenlandschaft**.
...
🤝 Schon 2022 konnten Bürger:innen dort Probleme, Gefahrenstellen und Ideen für den Radverkehr direkt auf Karten verorten – von fehlenden Radwegen bis zu kritischen Kreuzungen.
Lokales Alltagswissen wurde so zu nutzbaren Geodaten.

Genau das ist der Kern von Participatory GIS (PGIS):
Geoinformatik wird genutzt, um Bürgerwissen systematisch in Karten, Analysen und Planungsprozesse einzubinden – digital und transparent.

Heute ist dieser Ansatz ein fester Bestandteil der **<span style="color:blue">Smart-City-Strategie Jenas</span>** 🌍💡.
Über partizipative Karten und Online-Beteiligungsformate können Bürger:innen aktiv an der Stadtentwicklung mitwirken – etwa zu Mobilität 🚲, Stadtgrün 🌳, Barrierefreiheit ♿ oder Quartieren 🏘️.

👉 Karten sind nicht nur Analysewerkzeuge – sie sind Dialogräume zwischen Stadtgesellschaft und Entscheidungsträgern.
...
<p class="caption"><span id="fig:unnamed-chunk-18"></span>Figure 1: Bewegungsraten eines Blockgletschers in den chilenischen Anden. (c) X. Bodin.</p>
</div>
...
<p class="caption"><span id="fig:unnamed-chunk-25"></span>Figure 2: QGIS in der Lehre. Foto: (c) S. Hese.</p>
</div>
...
<p class="caption"><span id="fig:unnamed-chunk-27"></span>Figure 3: Eintreffzeiten der Feuerwehren im Stadtgebiet von Jena. (c) Stadt Jena / antwortING / otz.</p>
</div>
...
<p class="caption"><span id="fig:unnamed-chunk-28"></span>Figure 4: Das Einzugsgebiet des FC Carl Zeiss Jena aus Sicht der Verteilung seiner Mitglieder. (c) Thüringer Allgemeine.</p>
</div>


<div class="figure">
<img src="figures/fcc.png" alt="Die Südkurve im Ernst-Abbe-Sportfeld. Ihr Einzugsgebiet? Wo auch immer der FCC spielt!" width="50%" />
<p class="caption"><span id="fig:unnamed-chunk-29"></span>Figure 5: Die Südkurve im Ernst-Abbe-Sportfeld. Ihr Einzugsgebiet? Wo auch immer der FCC spielt!</p>
</div>
...
<p class="caption"><span id="fig:unnamed-chunk-31"></span>Figure 6: Drohnenaufnahmen von Adélie- und Gentoo-Pinguinkolonien auf Ardley Island, Antarktis. Pfeifer et al. (2025) in Ecological Indicators, </p>
</div>
...
<p class="caption"><span id="fig:unnamed-chunk-34"></span>Figure 7: Geostatistisch interpolierte Überschreitungswahrscheinlichkeiten für einen Nitratschwellenwert von 50 mg/l in einer nicht identifizierten Pilotregion.</p>
</div>
...
<div class="figure">
<img src="figures/gps_rgl_creep.jpg" alt="Bewegungsraten eines Blockgletschers in den chilenischen Anden. (c) X. Bodin." width="70%" />
<p class="caption"><span id="fig:unnamed-chunk-40"></span>Figure 8: Bewegungsraten eines Blockgletschers in den chilenischen Anden. (c) X. Bodin.</p>
</div>
...
<p class="caption"><span id="fig:unnamed-chunk-42"></span>Figure 9: Geocodierte Polizeiberichte.</p>
</div>
