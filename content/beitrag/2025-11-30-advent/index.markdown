...
<p class="caption"><span id="fig:unnamed-chunk-3"></span>Figure 1: Eintreffzeiten der Feuerwehren im Stadtgebiet von Jena. (c) Stadt Jena / antwortING / otz.</p>
</div>
...
<p class="caption"><span id="fig:unnamed-chunk-4"></span>Figure 2: Das Einzugsgebiet des FC Carl Zeiss Jena aus Sicht der Verteilung seiner Mitglieder. (c) Thüringer Allgemeine.</p>
</div>


<div class="figure">
<img src="figures/fcc.png" alt="Die Südkurve im Ernst-Abbe-Sportfeld. Ihr Einzugsgebiet? Wo auch immer der FCC spielt!" width="50%" />
<p class="caption"><span id="fig:unnamed-chunk-5"></span>Figure 3: Die Südkurve im Ernst-Abbe-Sportfeld. Ihr Einzugsgebiet? Wo auch immer der FCC spielt!</p>
</div>
...
<p class="caption"><span id="fig:unnamed-chunk-7"></span>Figure 4: Drohnenaufnahmen von Adélie- und Gentoo-Pinguinkolonien auf Ardley Island, Antarktis. Pfeifer et al. (2025) in Ecological Indicators, </p>
</div>
...
<p class="caption"><span id="fig:unnamed-chunk-10"></span>Figure 5: Geostatistisch interpolierte Überschreitungswahrscheinlichkeiten für einen Nitratschwellenwert von 50 mg/l in einer nicht identifizierten Pilotregion.</p>
</div>
...
<p class="caption"><span id="fig:unnamed-chunk-16"></span>Figure 6: Bewegungsraten eines Blockgletschers in den chilenischen Anden. (c) X. Bodin.</p>
</div>
...
<p class="caption"><span id="fig:unnamed-chunk-18"></span>Figure 7: Geocodierte Polizeiberichte.</p>
</div>
