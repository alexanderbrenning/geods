...
My recent contribution [(Brenning 2022)](https://doi.org/10.1080/13658816.2022.2131789) proposes novel spatial diagnostic tools that address these issues:
...
Here we will have a brief look at a well-known dataset that is often used to introduce geostatistics, but in the paper I also demonstrate their application to a classical remotely-sensed land cover classification problem [(Brenning 2022)](https://doi.org/10.1080/13658816.2022.2131789).
...
<div id="ref-brenning.2022.spdiag" class="csl-entry">
